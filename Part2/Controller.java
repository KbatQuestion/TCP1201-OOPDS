...
public class Controller {
    ...
    public void isCredentialValid(String password, String id) {
        ...
        if (containsOnlyNumbers(id)) {
            ...
            HashMap<Integer, String> tempTeacherPasswordHashMap = new HashMap<>();
            tempTeacherPasswordHashMap.putAll(loadFromFileForLecturer());
            HashMap<Integer, String> tempStudentPasswordHashMap = new HashMap<>();
            tempStudentPasswordHashMap.putAll(loadFromFileForStudent());
